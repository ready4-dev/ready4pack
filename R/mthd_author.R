...
#' @description author.ready4pack_manifest() is an Author method that writes files to local or remote locations. This method is implemented for the ready4 s3 class Manifest for packages containing datasets. The function is called for its side effects and does not return a value.
